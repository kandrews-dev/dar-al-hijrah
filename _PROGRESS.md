...
| **Hadeeth** | 12% | 🟡 In progress | **Science of Hadith intro** (sanad/matn, isnād, ṣaḥīḥ→mawḍūʿ, the books) · **Nawawī 1–5** (niyyah · Jibrīl · five pillars · خلق الجنين والقدر qadar `hd-h04` · **رد البدعة rejecting innovation `h05-bidah.html` `hd-h05`** — the Ibn Rajab inward/outward two-scales pairing with Hadith 1, cross-links Aqeedah bidʿah lesson; chained 1→5) · **Riyāḍ al-Ṣāliḥīn intro**. Two tracks live on the hub, chained. Per user: year-1 basics + the ḥadīth science, nothing advanced. | Nawawī 6–42 · Riyāḍ chapters (patience, truthfulness, akhlāq…) |
